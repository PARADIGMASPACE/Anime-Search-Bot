        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=i18n.t("keyboard.search", lang=lang),
                    callback_data="search_mode",
                ),
                InlineKeyboardButton(
                    text=i18n.t("keyboard.favorites", lang=lang),
...
def get_anime_selection_keyboard(multiple_results, lang):
    ...
    for result in multiple_results:
        ...
        buttons.append(
            [
                InlineKeyboardButton(
                    text=button_text, callback_data=f"view_anime:{result['id']}"
                )
            ]
        )
    ...
    buttons.append(
        [
            InlineKeyboardButton(
                text=i18n.t("keyboard.back", lang=lang), callback_data="back_to_search"
            ),
            InlineKeyboardButton(
                text=i18n.t("keyboard.menu", lang=lang), callback_data="back_to_menu"
            ),
        ]
    )
...
def get_anime_menu_keyboard(
    ...
    text = (
        i18n.t("keyboard.remove_favorite", lang=lang)
        if is_favorite
        else i18n.t("keyboard.add_favorite", lang=lang)
    )
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=i18n.t("keyboard.back", lang=lang), callback_data=back_action
                )
            ],
        ]
    )
...
def get_favorites_list_keyboard(
    favorites_list, lang: str, page: int = 1, page_size: int = 15
) -> InlineKeyboardMarkup:
    ...
    for fav in page_favorites:
        title = (
            fav.get(title_key)
            or fav.get(fallback_key)
            or i18n.t("keyboard.no_title", lang=lang)
        )
        if len(title) > 35:
            title = title[:32] + "..."
        buttons.append(
            [
                ...
                InlineKeyboardButton(
                    text="❌", callback_data=f"remove_fav:{fav['anime_id']}"
                ),
            ]
        )
...
def get_language_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=i18n.t("keyboard.language_english"),
                    callback_data="set_language:en",
                ),
                InlineKeyboardButton(
                    text=i18n.t("keyboard.language_russian"),
...
def update_language_keyboard(lang):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=i18n.t("keyboard.language_english", lang=lang),
                    callback_data="update_language:en",
                ),
                InlineKeyboardButton(
                    text=i18n.t("keyboard.language_russian", lang=lang),
                    callback_data="update_language:ru",
                ),
            ]
        ]
    )
