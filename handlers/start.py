...
async def start(message: types.Message, lang: str | None):
    ...
    logger.info(f"Handler 'start' started | user_id: {user_id} | username: @{username} | has_lang: {lang is not None}")
    ...
    try:
        if lang:
            ...
            logger.info(f"Handler 'start' completed | user_id: {user_id} | action: main_menu_shown")
        else:
            await message.answer(
                text=i18n.t("keyboard.language_select"),
                reply_markup=get_language_keyboard()
            )
            logger.info(f"Handler 'start' completed | user_id: {user_id} | action: language_selection_shown")
...
async def change_language(message: types.Message, lang: str):
    ...
    try:
        if lang:
            ...
            logger.info(f"Handler 'change_language' completed | user_id: {user_id} | action: update_keyboard_shown")
        else:
            await message.answer(
                text=i18n.t("keyboard.language_select"),
                reply_markup=get_language_keyboard()
            )
            logger.info(f"Handler 'change_language' completed | user_id: {user_id} | action: language_selection_shown")
    except Exception as e:
        logger.error(f"Handler 'change_language' failed | user_id: {user_id} | error: {e}")
...
async def update_language(callback: types.CallbackQuery, lang: str):
    ...
    try:
        ...
        logger.error(f"Handler 'update_language' failed | user_id: {user_id} | data: {callback_data} | error: {e}")
...
async def set_language(callback: types.CallbackQuery):
    ...
    logger.info(f"Handler 'set_language' started | user_id: {user_id} | username: @{username} | data: {callback_data}")
    ...
    try:
        ...
        logger.error(f"Handler 'set_language' failed | user_id: {user_id} | data: {callback_data} | error: {e}")
...
async def handle_search_mode(callback: types.CallbackQuery, lang: str | None):
    ...
    logger.info(f"Handler 'handle_search_mode' started | user_id: {user_id} | username: @{username}")
    ...
    try:
        ...
        logger.info(f"Handler 'handle_search_mode' completed | user_id: {user_id} | action: search_prompt_shown")

    except Exception as e:
        logger.error(f"Handler 'handle_search_mode' failed | user_id: {user_id} | error: {e}")